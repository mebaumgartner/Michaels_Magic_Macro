...
#c filterWeight customSegmentationCells ):
	...
	elif JSF_package.configBasic.singleCellMethod == "Custom Jython Script":
		IJ.error("Michael, make the damn jython script function!")
	
	elif JSF_package.configBasic.singleCellMethod == "Custom ImageJ Macro":
		IJ.error("Michael, make the damn imageJ macro function!")
