...
shinyUI(
        ...
        ui <- navbarPage("Data Analysis With PECAn", 
                ...
                sidebarPanel(
                        ...
                        tipify(checkboxInput("runFishers2", "Run sample-by-sample Fisher's exact test?", FALSE), "Tick this box to run a fishers exact test for all the dying cells the border vs. center for each sample individually. Results will be displayed in the Sample-by-Sample Fisher Tests tab", trigger = "hover", placement = "right" ),
                        ...
                        tipify(uiOutput('effectSize'),"This selects the effect size metric to be used in pairwise comparisons", placement="right", trigger="hover" ),
                  ...
                  mainPanel(
                      ...
                      tabsetPanel(type="tabs", 
                                  ...
                                  #This panel shows the tests used testing parametric assumptions of t-tests, etc.
                                  tabPanel("Parametric Assumptions Testing",
                                           h4("Shapiro-Wilks test of normality"),
         ...
         tabPanel("Regression Analysis",
                  sidebarPanel(
                      ...
                      selectInput("regAdjust", "select p-adjustment method:", choices=c("none", "fdr", "holm","hochberg","hommel","bonferroni", "BY")),
