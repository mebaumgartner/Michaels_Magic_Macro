list.of.packages <- c("shiny", "PerformanceAnalytics", "boot", "MASS", "car", "ggplot2", "RColorBrewer", "ggpubr", "markdown", "ggsignif", "rhandsontable", "msm", "dplyr", "car", "magrittr", "ICSNP", "mvnormtest", "psych", "corrplot", "rcompanion", "stringr", "effsize", "sandwich", "ggthemes", "shinyBS", "shinythemes", "reshape2")
library(data.table)
library(ggplot2)
        ...
        ui <- navbarPage("Wing Disc Analysis", 
                         ...
                         tabPanel("Load and Analyze Data",
                                  ...
                                  sidebarPanel(
                                      ...
                                      selectInput("sepTimePoints", "Specify Analysis Type:", c("Default", "Preserve timepoint information", "Preserve Z-plane information")),
                                     ...
                                     tipify(actionButton("go", "Analyze!"), "Press this button to analyze your data. Results will show in the Analyzed Data Table tab"),
                                      ...
                                      tipify(checkboxInput("excluded", "Omit datapoints?", FALSE), "Tick this box in order to exclude datapoints based on a specified criterion. Any datapoints which satisfy the specified operation will be retained. Those that do not will be excluded from analysis and the graph.", placement="right", trigger="hover" ),
                         ...
                         tabPanel("Analyzed Data Table",
                                  ...
                                  fluidRow(
                                          column(3,
                                          tipify(h4("Data operations:"),"Here, you can transform or perform operations on your data. The new data will be added as a new column to the table.", placement="right", trigger="hover" ),
                         ...
                         tabPanel("Regression Analysis",
                                  sidebarPanel(
                                      ...
                                      tipify(uiOutput("regressionSelect1"), "Select the dependent variable for regression analysis. In the case of logistic regression wherein you have your counts of successes and failures in separate columns, use this column to specify the failures column.", placement="right", trigger="hover" ),
